...
var _cloneState = __webpack_require__(300);
...
var timeMachine = exports.timeMachine = function timeMachine(preloadedState) {
  ...
  var getState = function getState() {
    ...
    return branch.state.length ? (0, _cloneState.cloneState)(branch.state[branch.index]) : 'No state.';
  };
  ...
  return { getState: getState, next: next, previous: previous };
};
...
var tree = timeMachine({ test: 1 });

tree.next({ test: 2 });

var prev = tree.previous();
var next = tree.next();
var curr = tree.getState();
...
var cloneState = exports.cloneState = function cloneState(val) {
