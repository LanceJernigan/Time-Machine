...
var _timeMachine = __webpack_require__(303);
...
var test = (0, _timeMachine.timeMachine)({
  test: 1
});
...
var cloneState = function cloneState(val) {
...
exports.timeMachine = undefined;

var _cloneState = __webpack_require__(302);

var _cloneState2 = _interopRequireDefault(_cloneState);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var timeMachine = exports.timeMachine = function timeMachine(preloadedState) {
  ...
  var getState = function getState() {
    var branchKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : currentBranchKey;
    var branchIndex = arguments[1];


    branchIndex = !isNaN(branchKey) ? branchKey : branchIndex;
    branchKey = !isNaN(branchKey) ? currentBranchKey : branchKey;

    var branch = getBranch(branchKey);

    return branch.state.length ? (0, _cloneState2.default)(branch.state[branch.index]) : 'No state.';
  };
  ...
  var updateBranch = function updateBranch(_ref) {
  ...
  */
  ...
  var checkout = function checkout(branch, preloadedState) {
  ...
  var reduce = function reduce(callback, initial) {
  ...
  return { getState: getState, next: next, previous: previous, checkout: checkout, map: map, filter: filter, reduce: reduce };
};
